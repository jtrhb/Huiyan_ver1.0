...
$noflags = explode(',', $noflag);
        ...
        {
$numquery = "Select id From `#@__archives` arc where {$this->addSql} $noflagsql $ordersql";
...
$row['scores'] = $cacherow['scores'];
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<span class=\"prev\"><a href='".str_replace("{page}",$prepagenum,$tnamerule)."'>&lt;</a></span>\r\n";
            $indexpage="<span class=\"first\"><a href='".str_replace("{page}",1,$tnamerule)."'>|&lt;</a></span>\r\n";
        }
        else
        {
            $indexpage="";
        ...
        {
            $nextpage.="<span class=\"next\"><a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'>&gt;</a></span>\r\n";
            $endpage="<span class=\"end\"><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>&gt;|</a></span>\r\n";
        }
        else
        {
            $endpage="";
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<span class=\"prev\"><a href='".$purl."PageNo=$prepagenum'>&lt;</a></span>\r\n";
            $indexpage="<span class=\"first\"><a href='".$purl."PageNo=1'>|&lt;</a></span>\r\n";
        }
        else
        {
            $indexpage="";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<span class=\"next\"><a href='".$purl."PageNo=$nextpagenum'>&gt;</a></span>\r\n";
            $endpage="<span class=\"end\"><a href='".$purl."PageNo=$totalpage'>&gt;|</a></span>\r\n";
        }
        else
        {
            $endpage="";
