...
class MemberListview
{
    ...
    function GetPageList($atts,$refObj='',$fields=array())
    {
        ...
        if($this->pageNO!=1)
        {
            $prepage.="<span class=\"prev\"><a href='".$purl."pageno=$prepagenum'>$lang_pre_page</a></span>\r\n";
            $indexpage="";
        }
        else
        {
        ...
        {
            $nextpage.="<span class=\"next\"><a href='".$purl."pageno=$nextpagenum'>$lang_next_page</a></span> \r\n";
            $endpage="<span class=\"end\"><a href='".$purl."pageno=$totalpage'>$lang_end_page</a></span> \r\n";
        }
        else
        {
            $endpage="";
