    ...
    if($dopost=='regbase')
    {
       ...
       '0','$spaceSta','','$safequestion','$safeanswer','$jointime','$joinip','$logintime','$loginip'); ";
        if($dsql->ExecuteNoneQuery($inQuery))
        {
            ...
            //写入欢迎短信
            $welcomequery = "INSERT INTO `#@__member_pms`(`floginid` ,`fromid` ,`toid` ,`tologinid` ,`folder` ,`subject`, `sendtime` ,`writetime`,`hasview`,`isadmin`,`message`)
                    VALUES('dede58','1','{$mid}','{$userid}','inbox','欢迎您注册为本站会员','{$jointime}','{$jointime}','0','1','欢迎您注册为本站会员！'); ";
            $dsql->ExecuteNoneQuery($welcomequery);			
