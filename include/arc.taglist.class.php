...
class TagList
{
    ...
    function GetPageListDM($list_len,$listitem="info,index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<span class=\"prev\"><a href='".$purl."/$prepagenum/'>&lt;</a></span>\r\n";
            $indexpage="<span class=\"first\"><a href='".$purl."/1/'>|&lt;</a></span>\r\n";
        }
        else
        {
            $indexpage="";
        ...
        {
            $nextpage.="<span class=\"next\"><a href='".$purl."/$nextpagenum/'>&gt;</a></span>\r\n";
            $endpage="<span class=\"end\"><a href='".$purl."/$totalpage/'>&gt;|</a></span>\r\n";
        }
        else
        {
            $endpage="";
