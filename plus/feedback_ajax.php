...
<div class="clearfix pinglun-box pinglun-box-set">
        <div class="user-img wz-author">
            <a href="<?php echo $spaceurl; ?>" title="<?php echo $username; ?>" class="tx-img" target="_blank" ><img src="<?php echo $mface;?>" width="50" height="50"></a></div>

        <div class="pinglun-box-text">
            <a class="name" href="<?php echo $spaceurl; ?>" target="_blank" title="<?php echo $username; ?>" ><?php echo $username; ?></a><span class="signature" title=""></span>
            <div class="view-info"><?php echo ubb($msg); ?></div>
        </div>

        <div class="clearfix view-func">
            <time class="pull-left s-time"><?php echo GetDateMk($dtime); ?></time>      
            <span class="agree" id='goodfb<?php echo $id; ?>' onclick="postBadGood('goodfb',<?php echo $id; ?>);"><i class="icon-i"></i>顶<span>(<?php echo $good; ?>)</span></span>
            <span class="disagree" onclick="postBadGood('badfb',<?php echo $id; ?>);"><i class="icon-i"></i>踩<span>(<?php echo $bad; ?>)</span></span>
...
<div class="clearfix pinglun-box pinglun-box-set">
        ...
        <div class="clearfix view-func">
            <time class="pull-left s-time"><?php echo GetDateMk($dtime); ?></time>      
            <span class="agree" id='goodfb<?php echo $id; ?>' onclick="postBadGood('goodfb',<?php echo $id; ?>);"><i class="icon-i"></i>顶<span>(<?php echo $good; ?>)</span></span>
            <span class="disagree" id='badfb<?php echo $id; ?>' onclick="postBadGood('badfb',<?php echo $id; ?>);"><i class="icon-i"></i>踩<span>(<?php echo $bad; ?>)</span></span>
